...
function create_if_block3(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(section, file4, 160, 1, 5034);
    },
    m: function mount(target, anchor) {
  ...
  dispatch_dev("SvelteRegisterBlock", {
    ...
    type: "if",
    source: "(160:0) {#if $toasts.length > 0}",
    ctx
  });
  return block;
}
...
function create_each_block_1(key_1, ctx) {
  ...
  toast_1 = new Toast_default({
    props: {
      ...
      actionButtonStyle: (
        /*toastOptions*/
        ctx[6]?.actionButtonStyle || ""
      ),
      cancelButtonStyle: (
        /*toastOptions*/
        ctx[6]?.cancelButtonStyle || ""
      ),
      class: (
        /*toastOptions*/
        ctx[6]?.class || ""
  ...
  dispatch_dev("SvelteRegisterBlock", {
    ...
    type: "each",
    source: "(193:4) {#each $toasts.filter((toast) => (!toast.position && index === 0) || toast.position === position) as toast, index (toast.id)}",
    ctx
  });
  return block;
}
function create_each_block2(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(ol, file4, 162, 3, 5152);
    },
    m: function mount(target, anchor) {
  ...
  dispatch_dev("SvelteRegisterBlock", {
    ...
    type: "each",
    source: "(162:2) {#each possiblePositions as position, index}",
    ctx
  });
  return block;
}
